...
#    MERGE_PATH=/data/the_pile_public_merged_nopreprocessing/gpt2-merges.txt
    ...
    DATA_PATH=/share_nfs/dataset/tokenized/lightyear/zh/wudao/v3_tokenized/tokenized_text_document
...
run_cmd="deepspeed /share_nfs/duanqiyuan/code/Megatron-DeepSpeed/pretrain_gpt.py ${megatron_options} ${data_options} ${deepspeed_options} &> ${OUTPUT_BASEPATH}/log/${NAME}_${host}_${current_time}.log&"
tail -f ${OUTPUT_BASEPATH}/log/${NAME}_${host}_${current_time}.log
echo ${run_cmd}
eval ${run_cmd}
set +x
